...
n_rows = 1_000_000 # 1million trials
n_cols = 2
...
# when len(np.unique() == 22) we have a situation where 2 people have the same bday so that bday is not unique
...
# length of list of twin bdays is the number of times we had a class with shared bdays, divide that by total simulations
